...
namespace PBMS.AI.API.Services
{
    public class CacheWarmupService : BackgroundService
    {
        ...
        {
            // Initial boot delay to ensure Identity and Registry services are fully up
        ...
        private async Task PerformCacheSyncAsync()
        {
            ...
            // 2. Multi-Criteria Objective Function Evaluation
            double w1 = 0.4; // Distance Weight
            double w2 = 0.3; // Floor Level Weight
            double w3 = 0.2; // Utilization Balance Weight (Distribute load)
            double w4 = 0.1; // Duration Match Weight (Short term by default)
