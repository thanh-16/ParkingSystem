...
namespace PBMS.Payment.API.Controllers
{
    ...
    public class PaymentController : ControllerBase
    {
        ...
        public async Task<IActionResult> ProcessMomoPayment([FromBody] PaymentRequest request, [FromHeader(Name = "X-Idempotency-Key")] string? idempotencyKey)
        {
            ...
            // Publish PaymentCompletedEvent asynchronously under MassTransit EF outbox
        ...
        // Webhook callback simulator for third-party gateways (MoMo/VNPay)
        [HttpPost("webhook")]
        [AllowAnonymous] // Gateways call this unauthenticated, secured via signature check
